...
\section{Applications on Aakash(Android)}
  ...
  \begin{frame}{IPython notebook}
    ...
    \end{itemize}
      \centerline{\href{file:///opt/techfest2013/ipython.3gp}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
  \end{frame}
  ...
  \begin{frame}{Aakash Programming Lab}
    ...
    \end{itemize}
      \centerline{\href{file:///opt/techfest2013/apl.3gp}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
  \end{frame}
