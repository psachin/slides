...
\definecolor{sky}{rgb}{0,104,139}

\definecolor{darkblue}{rgb}{0.0,0.0,0.6}
\definecolor{cyan}{rgb}{0.0,0.6,0.6}
\definecolor{pk}{rgb}{199,21,133}
...
\lstset{ %
  ...
  extendedchar=true,              % lets you use non-ASCII characters;
%  frame=single,                   % adds a frame around the code
  keywordstyle=\color{red},      % keyword style
%  language=xml,                % the language of the code
  morekeywords={android,intent,application,activity,intent,filter,action,category},           % if you want to add more keywords
  numbers=left,                   % where to put the line-numbers;
  numbersep=1pt,                  % how far the line-numbers are from
...
%  identifierstyle=\color{darkblue},
 ...
 \section{Applications on Aakash(Android)}
   ...
   \begin{frame}{Aakash Programming Lab}
     ...
     \end{itemize}
       \centerline{\href{file:///opt/aakashdemo/apl.3gp}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
   \end{frame}
   ...
   \begin{frame}{Aakash Business Tool}
     \begin{itemize}
       ...
       \item Easy to use UI
         ...
         \end{itemize}
     \end{itemize}
       \centerline{\href{file:///opt/aakashdemo/abt.avi}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
   \end{frame}
 ...
 \begin{frame}{GNU/inux}
   \begin{block}{}
     ...
     \end{itemize}
   \end{block}
   \centerline{\href{file:///opt/aakashdemo/linux.3gp}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
 \end{frame}
 ...
 \begin{frame}{Arduino on Aakash}
   \begin{block}{Arduino Uno  {\tt (http://arduino.cc)} }
     ...
     \end{itemize}
   \end{block}
   \centerline{\href{file:///opt/aakashdemo/arduino.3gp}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
 \end{frame}
 ...
 \begin{frame}{expEyes on Aakash}
   \begin{block}{expEyes}
     ...
     \end{itemize}
   \end{block}
   \centerline{\href{file:///opt/aakashdemo/expEyes.3gp}{\includegraphics[height=0.8cm,width=0.8cm]{play.jpg}}}
 \end{frame}
...
\begin{frame}[fragile]
  \frametitle{\texttt{AndroidManifest.xml}}
    \lstinputlisting[language=XML,firstline=1, lastline=15]{AndroidManifest.xml}
    %% \pause
...
\begin{frame}[fragile]
  \frametitle{\texttt{/src/com/icfoss/events/MainActivity.java}}
    \lstinputlisting[language=java,firstline=20, lastline=26]{MainActivity.java}
\end{frame}

\begin{frame}[fragile]
  \frametitle{\texttt{/res/layout/activity\_main.xml}}
    \lstinputlisting[language=java,firstline=1, lastline=14]{activity_main.xml}
\end{frame}
 ...
 \begin{frame}{References and links}
   \begin{block}{}
     \begin{itemize}
       \item {\url developer.android.com}
       \item {\url www.youtube.com/playlist?list=PL4CC7F724314E6C42}
       \item {\url www.mkyong.com/tutorials/android-tutorial}
       \item {\url http://code.google.com/p/android-scripting}
     \end{itemize}
   \end{block}
 \end{frame}
